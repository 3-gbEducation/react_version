								...
								<div className='row align-items-center w3l-forms-9'>
									<div className='main-midd col-md-5'>
										<h4 className='title-head mb-lg-2'>
											Subscribe to get latest Academic Updates{' '}
										</h4>
										<p>Newsletter</p>
									</div>
							...
							<div className='row sub-columns'>
								<div className='col-lg-2 col-sm-6 sub-two-right pl-lg-5 mt-lg-0 mt-sm-5 mt-4'>
									...
									<ul>
										<li>
											<NavLink to='/about'>
												<span className='fa fa-angle-double-right mr-2'></span>About
											</NavLink>
										</li>
										<li>
											<NavLink to='/soon'>
												<span className='fa fa-angle-double-right mr-2'></span>Micro
												Courses
											</NavLink>
										</li>
										<li>
											<NavLink to='/find-tutor'>
												<span className='fa fa-angle-double-right mr-2'></span>Find
												a Tutor
											</NavLink>
										</li>
										<li>
											<NavLink to='/'>
												<span className='fa fa-angle-double-right mr-2'></span>Free
												Demo
											</NavLink>
										</li>
									</ul>
									...
									<ul>
										<li>
											<a href='https://wa.me/919350227009'>
												<span className='fa fa-angle-double-right mr-2'></span>Live
												Chat
											</a>
										</li>
										<li>
											<a href='/faq'>
												<span className='fa fa-angle-double-right mr-2'></span>FAQ
											</a>
										</li>
										<li>
											<NavLink to='/contact'>
										...
										<li>
											<NavLink to='/soon'>
												<span className='fa fa-angle-double-right mr-2'></span>Terms
												of Services
											</NavLink>
										</li>
									</ul>
								...
								<div className='col-lg-3 col-sm-6 sub-one-left pl-lg-5 mt-lg-0 mt-sm-5 mt-4'>
									...
									<div className='column2'>
										...
										<div className='href2'>
											...
											<a href='tel:+9350227009'>+91 9350227009</a>
										</div>
										<div>
											<p className='contact-para'>
												...
												<NavLink to='/contact'>Radaur, Haryana</NavLink>
											</p>
										</div>
									</div>
								</div>
								<div className='col-lg-4 col-sm-6 sub-one-left ab-right-cont pl-lg-5 mt-lg-0 mt-sm-5 mt-4'>
									<h6>About </h6>
									<p>
										This platform is the culmination of a long research based on
										problems faced by teachers and students while interacting
										with each other on online platforms. We aim to make learning
										easy,personalised,affordable and interactive while creating
										no sort of burden on students and teachers.
									</p>
									<div className='columns-2'>
										<ul className='social'>
											...
											<li>
												<a href='https://www.facebook.com/3gbeducation'>
													<span
				...
				<div className='copyright-footer text-center'>
					<div className='container'>
						<div className='columns'>
							<p>
								@2021 3-gb. All rights reserved. Design by{' '}
								<span>
