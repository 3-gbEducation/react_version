...
export const blogs = [
  {
    id: "1",
    image: "https://miro.medium.com/max/1050/1*0yBxBAlFo2niLaDwMqiu2Q.jpeg",
    author: "Shivangi Garg",
    authorLink: "https://shivangi-160997.medium.com/",
    title: "Artificial Intelligence",
    intro:
      "Artificial intelligence (AI) refers to the simulation of human intelligence in machines that are programmed to think like humans and mimic their actions.",
    date: "2020-06-30T14:58:45.463+00:00",
    category: "Artificial Intelligence",
    tags: ["Learn", "skills", "education", "course"],
    content: `<h5><b>What is Artificial Intelligence(AI)?</b></h5>
  ...
  {
    id: "2",
    image: "https://miro.medium.com/max/1050/1*vOc_hckyamKWpCe-TzmioQ.jpeg",
    author: "Shivangi Garg",
    authorLink: "https://shivangi-160997.medium.com/",
    title: "2 Minutes with AI and The Future of Mankind!",
    intro:
      "Every age has its scientific discoveries and inventions. But today’s scientific advancement can impact globally in very short time. Such is the progress made in the field of artificial intelligence or AI..",
    date: "2020-07-06T15:36:51.709+00:00",
    category: "Technology",
    tags: ["website", "study", "skills", "education"],
    content: "",
  },
  {
    id: "3",
    image:
      "https://i.ibb.co/zR813xk/thomas-park-6-Me-Pt-A9-EVDA-unsplash-1.jpg",
    author: "Shivangi Garg",
    authorLink: "https://shivangi-160997.medium.com/",
    title: "Challenges faced by Students in Online Learning",
    intro:
      "Artificial intelligence (AI) refers to the simulation of human intelligence in machines that are programmed to think like humans and mimic their actions.",
    date: "2020-07-20T04:55:22.819+00:00",
    category: "O3 Education",
    tags: ["O3", "education", "challenges", "online"],
    content: "",
  },
  {
    id: "4",
    ...
    intro:
      "Every age has its scientific discoveries and inventions. But today’s scientific advancement can impact globally in very short time. Such is the progress made in the field of artificial intelligence or AI..",
    date: "2021-05-18T06:12:38.196+00:00",
    category: "Technology",
    tags: ["updates", "technology", "AI"],
    content: "",
  },
  {
    id: "5",
...
export const tags = (blogs) => {
  ...
  if (single.length <= 10) {
    ...
    while (arr.length < 10) {
      let r = Math.floor(Math.random() * single.length);
      if (arr.indexOf(single[r]) === -1) {
        arr.push(single[r]);
      }
    }
  }
...
// Popular posts
export const popularPost = (blogs) => {
  const arr = [];
  while (arr.length < 3) {
    let r = Math.floor(Math.random() * blogs.length);
    if (arr.indexOf(blogs[r]) === -1) {
      arr.push(blogs[r]);
    }
  }
  return arr;
